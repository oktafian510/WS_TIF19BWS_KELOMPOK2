<?php
include 'keranjang_pembayaran.php';
...
if (isset($_POST["submit"])) {
    ...
    if (tambah($_POST) > 0) {
        ...
        echo " <script> 
        alert('Transaksi sukses. Klik oke untuk melanjutkan pembayaran ');
        document.location.href = 'trans_jual_pembayaran.php?kd=$kd_jual '; 
        </script>";
    } else {
        echo " <script> 
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <form method="POST">
                    ...
                    <?php
                    $totalbayar = $_POST['sub_harga'];
                    $id_customers = $userid['id'];

                    $tb_keranjang = query(" SELECT * FROM tb_keranjang WHERE id_customers = $id_customers");
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input disabled class="form-control " type="text" value="<?= $row['kd_barang']  ?>" />
                                    <input hidden class="form-control " name="kd_barang" id="kd_barang" type="text" value="<?= $row["kd_barang"]; ?>" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="small mb-1" for="jumlah">Qty</label>
                                    <input disabled class="form-control " id="jumlah" type="number" value="<?= $row['jumlah'] ?>" onkeyup="sum();" />
                                    <input hidden class="form-control " name="jumlah" id="jumlah" type="number" value="<?= $row['jumlah'] ?>" onkeyup="sum();" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <label class="small mb-1" for="hargajual">Harga Satuan</label>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label class="small mb-1" for="sub_harga">Total Harga</label>

                                    <input disabled value="<?= $row["harga"]; ?>" class="form-control " type="text" id="sub_harga2" />
                                    <input hidden value="<?= $row["harga"]; ?>" class="form-control " name="sub_harga" id="sub_harga" type="text" />
                    ...
                    <?php endforeach; ?>
                    <input hidden type="text" value="<?= $jumlah; ?>" name="jumlah_jual" id="jumlah_jual">


                    <div class="form-row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="small mb-1" for="total_bayar">Total Bayar</label>
                                <input disabled value="<?= $totalbayar; ?>" class="form-control " id="total_bayar2" type="text" />
                                <input hidden value="<?= $totalbayar; ?>" class="form-control " name="total_bayar" id="total_bayar" type="text" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="small mb-1" for="diskon">Diskon</label>
                                <input disabled class="form-control " name="diskon" id="diskon" type="text" value="-" />
                    ...
                    <input type="hidden" name="id_customers" value="<?= $userid["id"]; ?>">
...
<script>
    function sum() {
        ...
        if (!isNaN(result2)) {
            document.getElementById('sub_harga2').value = result2;
            document.getElementById('total_bayar2').value = result2;
