                    ...
                    <?php foreach ($tb_barang as $row) : ?>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                <a href="#"><img class="card-img-top" src="<?= $row["foto"]; ?>" alt="" width="700px" height="150px"></a>
                                <div class="card-body">
                                    <h4 class="card-title">
                                        <a href="trans_jual.php?user=<?= $userid["username"]; ?>&kd_brg=<?= $row["kd_barang"]; ?>"><?= $row["nama_barang"]; ?></a>
                                    </h4>
