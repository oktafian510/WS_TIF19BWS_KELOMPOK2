...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <?php foreach ($tb_barang as $row) : ?>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="<?= $row["foto"]; ?>" alt="" width="700px" height="200px"></a>
                        <div class="card-body">
                            <h4 class="card-title">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-primary btn-block" href="contact.php?user=<?= $userid["username"]; ?>">Call to Action</a>
            </div>
        </div>
