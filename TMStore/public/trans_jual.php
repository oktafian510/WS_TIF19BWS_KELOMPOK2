...
if (isset($_POST["submit"])) {
    ...
    if ($user === 'Terverifikasi') {
        ...
        document.location.href = 'trans_jual_pembayaran.php?kd=$kd_jual '; 
            ...
            echo " <script> 
        alert('Transaksi Gagal Pastikan memasukkan jumlah yang benar'); 
            ...
            <div class="col-md-8">
                <form method="POST">
                    ...
                    <div class=" form-row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <input disabled value="<?= $brg["hargajual"]; ?>" class="form-control " type="text" id="sub_harga2" />
                    ...
                    <div class="form-row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input disabled value="<?= $brg["hargajual"]; ?>" class="form-control " id="total_bayar2" type="text" />
                    ...
                    <input type="hidden" name="user" value="<?= $userid["status"]; ?>">
