  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="">
        ...
        <div class="form-group">
          <input type="text" name="subject" id="name" class="form-control form-control-user" placeholder="Subjek Pesan Anda" required autocomplete="of">
        </div>
        <div class="form-group">
          <input type="email" name="email" id="name" class="form-control form-control-user" placeholder="Email Anda" required autocomplete="of">
        </div>
